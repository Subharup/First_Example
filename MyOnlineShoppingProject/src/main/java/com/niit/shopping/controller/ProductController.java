...
public class ProductController {
	...
	public ModelAndView AdminViewProductController(){  
	    List<Product> list=productDao.getAllProduct();
	    return new ModelAndView("AdminViewProduct","list1",list);  
	}  

	@RequestMapping("/AdminAddProduct")  
    public ModelAndView form(){  
        return new ModelAndView("AdminAddProduct","command",new Product());  
    }
	@RequestMapping(value="/AdminAddProductController",method = RequestMethod.POST) 
